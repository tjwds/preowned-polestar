const run = async () => {
  const res = await fetch(
    ...
    {
      body: '{"operationName":"SearchVehicleAds","variables":{"carModel":"PS2","market":"us","offset":0,"limit":100,"sortOrder":"Ascending","sortProperty":"Price","excludeFilters":[{"filterType":"CycleState","value":"New"}]},"query":"query SearchVehicleAds($carModel: CarModel!, $market: String!, $region: String, $offset: Int!, $limit: Int!, $sortOrder: SortOrder2!, $sortProperty: SortProperty!, $equalFilters: [EqualFilter!], $excludeFilters: [ExcludeFilter!]) {\\n  searchVehicleAds(\\n    carModel: $carModel\\n    market: $market\\n    region: $region\\n    offset: $offset\\n    limit: $limit\\n    sortOrder: $sortOrder\\n    sortProperty: $sortProperty\\n    equalFilters: $equalFilters\\n    excludeFilters: $excludeFilters\\n  ) {\\n    metadata {\\n      equalFilters {\\n        filterType\\n        labels {\\n          label\\n          locale\\n          __typename\\n        }\\n        resultCount\\n        totalCount\\n        thumbnail {\\n          alt\\n          url\\n          __typename\\n        }\\n        value\\n        __typename\\n      }\\n      limit\\n      offset\\n      resultCount\\n      totalCount\\n      __typename\\n    }\\n    vehicleAds {\\n      vatDeductible\\n      id\\n      versionTimestamp\\n      firstTimeRegistration\\n      price {\\n        retail\\n        dealer\\n        vat\\n        currency\\n        __typename\\n      }\\n      handoverLocation {\\n        city\\n        name\\n        __typename\\n      }\\n      partnerLocation {\\n        city\\n        name\\n        __typename\\n      }\\n      media {\\n        data\\n        mediaType\\n        __typename\\n      }\\n      mileageInfo {\\n        distance\\n        metric\\n        __typename\\n      }\\n      vehicleDetails {\\n        vin\\n        cycleState\\n        interior {\\n          code\\n          labels {\\n            locale\\n            label\\n            __typename\\n          }\\n          thumbnail {\\n            url\\n            alt\\n            __typename\\n          }\\n          __typename\\n        }\\n        pno34\\n        stockImages\\n        vehicleImages {\\n          url\\n          rawUrl\\n          imageType\\n          category\\n          angle\\n          __typename\\n        }\\n        motorInfo {\\n          labels {\\n            locale\\n            label\\n            __typename\\n          }\\n          value\\n          __typename\\n        }\\n        modelDetails {\\n          modelYear\\n          model\\n          edition\\n          __typename\\n        }\\n        rangeInformation {\\n          labels {\\n            label\\n            locale\\n            __typename\\n          }\\n          value\\n          __typename\\n        }\\n        engineDetails {\\n          powerInfo {\\n            locale\\n            label\\n            __typename\\n          }\\n          __typename\\n        }\\n        drivetrainInfo {\\n          label\\n          locale\\n          __typename\\n        }\\n        pilotPackage {\\n          labels {\\n            label\\n            locale\\n            __typename\\n          }\\n          __typename\\n        }\\n        plusPackage {\\n          labels {\\n            label\\n            locale\\n            __typename\\n          }\\n          __typename\\n        }\\n        exterior {\\n          code\\n          labels {\\n            label\\n            locale\\n            __typename\\n          }\\n          __typename\\n        }\\n        performancePackage {\\n          code\\n          labels {\\n            label\\n            locale\\n            __typename\\n          }\\n          __typename\\n        }\\n        vehicleAdExtras {\\n          id\\n          type\\n          items {\\n            id\\n            title\\n            image\\n            articleNumber\\n            __typename\\n          }\\n          languageCode\\n          __typename\\n        }\\n        seats\\n        __typename\\n      }\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n"}',
      cache: "default",
      credentials: "include",
      headers: {
        Accept: "*/*",
  ...
  vehicles
    .sort((a, b) => b.price.retail - a.price.retail)
    .forEach((vehicle) => {
      console.log(
        "$" + vehicle.price.retail + ` ($${vehicle.price.dealer} dealer price)`
      );
      console.log(
